...
class CadracksCoreFrame(Wx3dViewerFrame):
    r"""Specialization of aocutil's Wx3dViewerFrame for cadracks_core"""
    def __init__(self):
        Wx3dViewerFrame.__init__(self,
                                 title="cadracks_core 3d viewer",
                                 welcome="Starting cadracks_core 3d viewer ...")
...
def view_assembly(assembly):
    r"""Display using cadracks_core's integrated wx viewer"""
    assembly.build()
